...
def main(
    ...
    **kwargs,
    ...
    print(os.getcwd())
    print(os.chdir('/home/glard/AML/roost/roost'))
    print(os.getcwd())
...
def input_parser():
    ...
    parser.add_argument(
        "--data-path",
        type=str,
        default="/home/glard/AML/roost/roost/data/datasets/expt-non-metals.csv",
        metavar="PATH",
    ...
    parser.add_argument(
        "--fea-path",
        type=str,
        default="/home/glard/AML/roost/roost/data/embeddings/matscholar-embedding.json",
        metavar="PATH",
